# Generated by Django 4.1.7 on 2023-05-25 16:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('major', models.CharField(choices=[('CS', 'Computer Science'), ('CIS', 'Computer Information System'), ('BIT', 'Bussiness Information Technology'), ('Artifical Intelligence', 'AI'), ('Data Science', 'Data Science'), ('CyberSecurity', 'CyberSecurity')], max_length=70)),
